				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="80">退货订单ID</th>
							<th width="80">客户ID</th>
							<th width="100">支付方式</th>
							<th width="140">退货时间</th>
							<th width="100">总金额</th>							
							<th width="120">操作</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${returnsList}" var="salereturnOrder">						
							<tr class="text-c">
								<td><input type="checkbox" value="" name=""></td>								
								<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">${salereturnOrder.id}</u></td>
								<td>${salereturnOrder.customerId}</td>
								<td>${salereturnOrder.pay}</td>							
								<td>${salereturnOrder.returnDate}</td>							
								<td class="td-status"><span class="label label-success radius">${salereturnOrder.total}</span></td>
								<td class="f-14 td-manage">
									...
									<a style="text-decoration:none" class="ml-5" onClick="article_del(this,'10001')" href="javascript:;" title="退货"><i class="Hui-iconfont">&#xe6e2;</i></a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/salereturn/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/salereturn/multipageDown?curPage=${cutPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/salereturn/multipageUp?curPage=${cutPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/salereturn/multipage?curPage=${talPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						 第${cutPage}页/共${talPage}页 						
					</div>					
			</div>
		</article>
