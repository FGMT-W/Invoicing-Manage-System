	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">	
				...
				<a class="btn btn-primary radius" data-title="数据备份" href="/backups/backupes" onclick="article_add('数据备份','/backups/backupes')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 数据备份</a>
				文件名：
				<input type="text"  id="logmax" name="fileName" class="input-text Wdate" style="width:120px;">				
				<input name="" id="" class="btn btn-success" type="submit" value="数据恢复">
			</form>
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20">				
				
			</div>
			<div class="mt-20" style="float: left;margin-left: 450px">
				<span class="r" style="color: red;font-size: 20px" >${msg}</span>
			</div>
		</article>
