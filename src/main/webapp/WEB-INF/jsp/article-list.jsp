				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="80">采购订单ID</th>
							<th width="80">供应商ID</th>
							<th width="100">支付方式</th>
							<th width="140">采购时间</th>
							<th width="100">总金额</th>							
							<th width="120">操作</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${orderList}" var="purchaseOrder">						
							<tr class="text-c">
								...
								<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">${purchaseOrder.id}</u></td>
								<td>${purchaseOrder.suppliersId}</td>
								<td>${purchaseOrder.pay}</td>							
								<td>${purchaseOrder.inDate}</td>							
								<td class="td-status"><span class="label label-success radius">${purchaseOrder.total}</span></td>
								<td class="f-14 td-manage">
									...
									<a class="btn btn-primary radius" data-title="退货" href="/returnPurchase/addOrder?orderId=${purchaseOrder.id}" onclick="article_add('退货','/returnPurchase/addOrder?orderId=${purchaseOrder.id}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 退货</a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/purchase/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/purchase/multipageDown?curPage=${currentPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/purchase/multipageUp?curPage=${currentPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/purchase/multipage?curPage=${totalPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
