	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l">
				<a class="btn btn-primary radius" data-title="添加供应商" href="/suppliers-add.html" onclick="article_add('添加供应商','/suppliers-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加供应商</a>
				</span>
				<span class="r">共有数据：<strong>${couns}</strong> 条</span>
			</div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${goodsList}" var="suppliers">						
							<tr class="text-c">
								...
								<td>${suppliers.zip}</td>							
								<td>${suppliers.telPhone}</td>
								<td>${suppliers.linkMan}</td>
								<td>${suppliers.linkTel}</td>
								...
								<td class="f-14 td-manage">
									...
									<a class="btn btn-primary radius" data-title="删除" href="/sys/delSuppliers?orderId=${suppliers.id}" onclick="article_add('退货','/sys/delSuppliers?orderId=${suppliers.id}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 删除</a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/sys/multipage1?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipageDown1?curPage=${curtPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipageUp1?curPage=${curtPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipage1?curPage=${totaPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						 第${curtPage}页/共${totaPage}页 						
					</div>					
			</div>
		</article>
