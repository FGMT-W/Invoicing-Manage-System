		...
		<article class="cl pd-20">			
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${messageList}" var="message">						
							<tr class="text-c">
								...
								<td class="text-l"><u style="cursor:pointer" class="text-primary"><a href="/log/checkMessage?id=${message.id}" style="text-decoration: none;">${message.id}</a></u></td>
								<td>${message.date}</td>
								<td>${message.flag}</td>																
							</tr>						
						</c:forEach>
					...
					<div align="center">						
						<a href = "/log/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/log/multipageDown?curPage=${crrentPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/log/multipageUp?curPage=${crrentPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/log/multipage?curPage=${ttalPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
