...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">							
				<form action="/query/queryGoods">
				商品名称：
				<input type="text"  id="logmin" name="goodName" class="input-text Wdate" style="width:120px;">				
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					<thead>
						<tr class="text-c">
							...
							<th width="80">库存商品ID</th>
							<th width="80">商品名称</th>
							<th width="100">单位</th>
							<th width="100">商品产地</th>	
							<th width="140">供应商编号</th>
							<th width="140">价格</th>
							<th width="140">批准文号</th>
							<th width="140">生产批号</th>											
						</tr>
					</thead>
					<tbody>
