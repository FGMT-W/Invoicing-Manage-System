		...
		<article class="cl pd-20">			
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${goodsList}" var="goods">						
							<tr class="text-c">
								...
								<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">${goods.id}</u></td>
								<td>${goods.name}</td>
								<td>${goods.unit}</td>							
								<td>${goods.supplierId}</td>	
								<td>${goods.price}</td>
								<td>${goods.approveId}</td>
								<td>${goods.batchId}</td>									
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/sys/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipageDown?curPage=${curtPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipageUp?curPage=${curtPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipage?curPage=${totaPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
