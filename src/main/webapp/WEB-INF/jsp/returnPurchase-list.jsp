		...
		<article class="cl pd-20">			
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${returnList}" var="returnOrder">						
							<tr class="text-c">
								...
								<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">${returnOrder.id}</u></td>
								<td>${returnOrder.suppliersId}</td>
								<td>${returnOrder.pay}</td>							
								<td>${returnOrder.outDate}</td>							
								<td class="td-status"><span class="label label-success radius">${returnOrder.total}</span></td>
					...
					<div align="center">						
						<a href = "/returnPurchase/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/returnPurchase/multipageDown?curPage=${currPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/returnPurchase/multipageUp?curPage=${currPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/returnPurchase/multipage?curPage=${tatPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						 第${currPage}页/共${tatPage}页 						
					</div>					
			</div>
		</article>
