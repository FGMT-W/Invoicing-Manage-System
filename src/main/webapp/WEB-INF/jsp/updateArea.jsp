...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">							
				<form action="/stock/updateArea">
				商品ID：
				<input type="text"  id="logmin" name="goodsId" class="input-text Wdate" style="width:120px;">
				存放地方：
				<input type="text"  id="logmax" name="area" class="input-text Wdate" style="width:120px;">				
				<input name="" id="" class="btn btn-success" type="submit" value="移库">
			</form>
			</div>
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<div align="center">						
						<a href = "/stock/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/stock/multipageDown?curPage=${curPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/stock/multipageUp?curPage=${curPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/stock/multipage?curPage=${totPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
