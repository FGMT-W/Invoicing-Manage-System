	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加商品" href="/article-add.html" onclick="article_add('添加商品','/article-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a>
				<a class="btn btn-primary radius" data-title="添加订单" href="/purchase/sub" onclick="article_add('添加订单','/purchase/sub')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a>
				</span>
				<span class="r">共有数据：<strong>${cunt}</strong> 条</span>
			</div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${saleorderList}" var="saleOrder">						
							<tr class="text-c">
								...
								<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看">${saleOrder.id}</u></td>
								<td>${saleOrder.customerId}</td>
								<td>${saleOrder.pay}</td>							
								<td>${saleOrder.saleDate}</td>							
								<td class="td-status"><span class="label label-success radius">${saleOrder.total}</span></td>
								<td class="td-status"><span class="label label-success radius">${saleOrder.flag}</span></td>
								<td class="f-14 td-manage">
									...
									<a class="btn btn-primary radius" data-title="发货" href="/sale/outstock?orderId=${saleOrder.id}" onclick="article_add('发货','/sale/outstock?orderId=${saleOrder.id}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 发货</a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/sale/multipage1?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sale/multipageDown1?curPage=${crrentPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sale/multipageUp1?curPage=${crrentPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sale/multipage1?curPage=${ttalPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						 第${crrentPage}页/共${ttalPage}页 						
					</div>					
			</div>
		</article>
