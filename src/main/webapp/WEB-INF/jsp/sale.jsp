	...
	<div class="Hui-article">
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加商品" href="/add-goods.html" onclick="article_add('添加商品','/add-goods.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品</a>
				<a class="btn btn-primary radius" data-title="添加订单" href="/sale/forwordOrder" onclick="article_add('添加订单','/sale/forwordOrder')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a>
				</span>
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
						...
						<c:forEach items="${saleorderList}" var="saleOrder">						
							<tr class="text-c">
								...
								<td class="f-14 td-manage">
									...
									<a class="btn btn-primary radius" data-title="退货" href="/salereturn/addOrder?orderId=${saleOrder.id}" onclick="article_add('退货','/salereturn/addOrder?orderId=${saleOrder.id}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 退货</a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/sale/multipage?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sale/multipageDown?curPage=${crrentPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sale/multipageUp?curPage=${crrentPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sale/multipage?curPage=${ttalPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
