		...
		<article class="cl pd-20">
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${goodsList}" var="emplyee">						
							<tr class="text-c">
								...
								<td class="f-14 td-manage">
									...
									<a class="btn btn-primary radius" data-title="删除" href="/sys/delEmployee?orderId=${emplyee.id}" onclick="article_add('退货','/sys/delEmployee?orderId=${emplyee.id}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 删除</a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/sys/multipage3?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipageDown3?curPage=${curtPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipageUp3?curPage=${curtPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/sys/multipage3?curPage=${totaPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
