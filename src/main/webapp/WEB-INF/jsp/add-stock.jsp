		...
		<article class="cl pd-20">
			...
			<div class="mt-20">
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<c:forEach items="${orderList}" var="purchaseOrder">						
							<tr class="text-c">
								...
								<%--<c:if test="${purchaseOrder.total<10000000}">--%>
									<%--<td class="td-status"><span class="label label-success radius">${purchaseOrder.total}</span></td>--%>

								<%--</c:if>--%>
								<%--<c:if test="${purchaseOrder.total>=10000000}">--%>
									<%--<td class="td-status"><span class="label label-success radius">${purchaseOrder.total/10000}万</span></td>--%>

								<%--</c:if>--%>
								<td class="td-status"><span class="label label-success radius">${purchaseOrder.total/10000}万</span></td>

								<td class="td-status"><span class="label label-success radius">${purchaseOrder.flag}</span></td>
								<td class="f-14 td-manage">
									...
									<a class="btn btn-primary radius" data-title="入库" href="/purchase/addstock?orderId=${purchaseOrder.id}" onclick="article_add('入库','/purchase/addstock?orderId=${purchaseOrder.id}')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 入库</a>
								</td>
							</tr>						
						</c:forEach>
					</tbody>
					...
					<div align="center">						
						<a href = "/purchase/multipage1?curPage=1" >首页</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/purchase/multipageDown1?curPage=${currentPage}" >上一页</a> &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/purchase/multipageUp1?curPage=${currentPage}" >下一页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
						<a href = "/purchase/multipage1?curPage=${totalPage}">尾页</a>  &nbsp;&nbsp;&nbsp;&nbsp;
